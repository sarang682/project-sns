...
class PostControllerTest {
    ...
    @Test
    @WithMockUser
    void 포스트수정시_작성자와_요청자가_다를경우() throws Exception {
    ...
    @Test
    @WithMockUser
    void 포스트수정시_포스트가_존재하지_않을_경우() throws Exception {
    ...
    @Test
    @WithMockUser
    void 포스트삭제시_포스트가_존재하지_않을_경우() throws Exception {
    ...
    @Test
    @WithMockUser
    void 사용자의_피드목록() throws Exception {
    ...
    @Test
    @WithAnonymousUser
    void 사용자의_피드목록_요청시_로그인하지_않은경우() throws Exception {
        when(postService.my(any(),any())).thenReturn(Page.empty());
